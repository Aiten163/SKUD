...
namespace Orchid\Support\Facades {
     ...
     */        class Alert {
         ...
         *
         * @param string $message The message to flash.
         * @param \Orchid\Support\Color $color The color of the message (default: Color::INFO).
         * @return \Orchid\Alert\Alert 
         * @static 
         */        public static function message($message, $color = \Orchid\Support\Color::INFO)
        {
                        /** @var \Orchid\Alert\Alert $instance */
                        return $instance->message($message, $color);
        }
                    /**
         ...
         * @return \Orchid\Alert\Alert 
         * @static 
         */        public static function view($template, $color = \Orchid\Support\Color::INFO, $data = [])
        {
                        /** @var \Orchid\Alert\Alert $instance */
                        return $instance->view($template, $color, $data);
        }
                    /**
         ...
         * @return \Orchid\Alert\Alert 
         * @static 
         */        public static function withoutEscaping()
        {
                        /** @var \Orchid\Alert\Alert $instance */
                        return $instance->withoutEscaping();
        }
                    /**
     ...
     */        class Dashboard {
        ...
        {
                        return \Orchid\Platform\Dashboard::assetsAreCurrent();
        }
                    /**
        ...
        {
                        return \Orchid\Platform\Dashboard::configure($options);
        }
                    /**
         ...
         * @return \Orchid\Platform\Dashboard 
         * @static 
         */        public static function registerSearch($models)
        {
                        /** @var \Orchid\Platform\Dashboard $instance */
                        return $instance->registerSearch($models);
        }
                    /**
         ...
         *
         * @return \Illuminate\Support\Collection The collection of searchable models.
         * @static 
         ...
         * @static 
         */        public static function getPermission($groups = [])
        {
                        /** @var \Orchid\Platform\Dashboard $instance */
                        return $instance->getPermission($groups);
        }
                    /**
         ...
         * @param array|string $groups
         * @static 
         */        public static function getAllowAllPermission($groups = [])
        {
                        /** @var \Orchid\Platform\Dashboard $instance */
                        return $instance->getAllowAllPermission($groups);
        }
                    /**
         ...
         * @return \Orchid\Platform\Dashboard 
         * @static 
         */        public static function setCurrentScreen($screen, $partialRequest = false)
        {
                        /** @var \Orchid\Platform\Dashboard $instance */
                        return $instance->setCurrentScreen($screen, $partialRequest);
        }
                    /**
         * Get the current screen instance.
         *
         * @return \Orchid\Screen\Screen|null The current screen instance or null if not set.
         * @static 
         ...
         * @static 
         */        public static function isPartialRequest()
        {
                        /** @var \Orchid\Platform\Dashboard $instance */
                        return $instance->isPartialRequest();
        }
                    /**
         * Register a menu element with the Dashboard.
         *
         * @param \Orchid\Screen\Actions\Menu $menu The menu element to add.
         * @return \Orchid\Platform\Dashboard 
         * @static 
         */        public static function registerMenuElement($menu)
        {
                        /** @var \Orchid\Platform\Dashboard $instance */
                        return $instance->registerMenuElement($menu);
        }
                    /**
         ...
         * @static 
         */        public static function isEmptyMenu()
        {
                        /** @var \Orchid\Platform\Dashboard $instance */
                        return $instance->isEmptyMenu();
        }
                    /**
         * Add submenu items to a menu element identified by its slug.
         *
         * @param string $slug The slug of the menu element to update.
         * @param \Orchid\Screen\Actions\Menu[] $list Array of submenu items to add.
         * @return \Orchid\Platform\Dashboard 
         * @static 
         */        public static function addMenuSubElements($slug, $list)
        {
                        /** @var \Orchid\Platform\Dashboard $instance */
                        return $instance->addMenuSubElements($slug, $list);
        }
                    /**
