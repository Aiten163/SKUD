        ...
        return
            [
                ...
                Layout::modal('createdoor', Layout::rows([
                    ...
                    Input::make('unlock_duration')->title('Время занятия')->format('H:i:s'),
                    Input::make('unlock_duration')->title('Время занятия')->format('H:i:s'),
                ...
                (
                    [
                        ...
                        Input::make('door.unlock_duration')->title('Время занятия')->format('H:i:s'),
                        Input::make('door.warn_duration')->title('Время предупреждения')->format('H:i:s'),
                    ]
                ))->async('asyncGetDoor')
            ];
    }
